  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://mentor-piano-white-recordings.trycloudflare.com/auth/register",
        {
          method: "POST",
          headers: {
      ...
      localStorage.setItem(
        "user",
        JSON.stringify(data.user || { nome, email })
      );
      ...
      <div className="w-full max-w-md">
        ...
        <div className="brutalist-card mb-6">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <div>
              <label htmlFor="nome" className="block uppercase font-bold mb-1">
                Full Name
              </label>
              <Input
                id="nome"
